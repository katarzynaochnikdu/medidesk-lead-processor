string standalone.AccountsSprawdzCzyJestLepsza(String existingAccountRecordId)
{
    ...
    if(znalezioneFiremyStr1 != null && znalezioneFiremyStr1 != "")
    {
        ...
        {
            if(!uniqueIds.containKey(firmaId))
            {
    ...
    if(najlepszaFirmaId != existingAccountRecordId)
    {
        ...
        if(existingAccount != null)
        {
            ...
            // Jeśli nie ma już kontaktów i scoring < 5, usuń firmę
            if(!hasPowiazania && existingTotalScore < 5)
            {
            ...
            else
            {
                ...
                responseMap.put("usunietoFirme", false);
                responseMap.put("powodBrakUsuniecia", "Powiązane kontakty: " + hasPowiazania + ", Scoring: " + existingTotalScore);
            }
