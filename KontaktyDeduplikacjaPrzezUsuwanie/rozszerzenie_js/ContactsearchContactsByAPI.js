string standalone.searchContactsByAPI(String criteria, String accessToken)
{
    try {
        ...
        // Przygotowanie URL do API z uniwersalnymi kryteriami
        apiURL = "https://www.zohoapis.eu/crm/v7/Contacts/search?criteria=(" + encodeUrl(criteria) + ")";
